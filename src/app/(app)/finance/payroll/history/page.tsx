...
/**
 * Finance › Payroll › History — what was actually owed, month by month.
 *
 * ─────────────────────────────────────────────────────────────────────────────
...
function HistoryScreen() {
  ...
  const select = React.useCallback(
    (period: { year: number; month: number } | null) => {
      ...
      router.replace(
        period
          ? `/finance/payroll/history?year=${period.year}&month=${period.month}`
        ...
        <EmptyState
          ...
          action={
            <Button variant="primary" asChild>
              <Link href="/finance/payroll">Open current payroll</Link>
            </Button>
          }
        />
      </Card>
