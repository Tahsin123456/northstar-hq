...
/**
 * Finance › Payroll — what the team is owed for the month in progress.
 *
 * ─────────────────────────────────────────────────────────────────────────────
 ...
 * walking a colleague into a screen whose every request would 403. The Finance
 * section's own payroll/layout.tsx makes the same check on the server before
 * any of this renders, which is what a typed URL meets.
 */
        ...
        actions={
          <div className="flex flex-wrap items-center gap-2">
            <Button variant="secondary" size="sm" asChild>
              <Link href="/finance/payroll/history">
                <History />
                Payroll history
              </Link>
            </Button>
    ...
    <>
      <Card className="flex flex-col gap-3 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex shrink-0 flex-wrap items-center gap-2">
          ...
          <Button variant="secondary" size="sm" asChild>
            <Link
              href={`/finance/payroll/history?year=${previous.year}&month=${previous.month}`}
            >
              Open
            </Link>
          </Button>
